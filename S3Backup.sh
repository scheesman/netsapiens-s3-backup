...
while [ $# -gt 0 ]; do
  ...
  case "$1" in
    ...
    cdr2last)
      ...
      file_name="cdrdomain-cdr2last_${hostname}_${cdr2last}.sql"
    ...
    cdr2)
      ...
      file_name="cdrdomain-cdr2_${hostname}_${cdr2current}.sql"
    ...
    recording)
      ...
      ;;
    *)
    echo "Specify backup type: core,cdr,cdr2,cdr2last,conference,messaging,ndp,ndpfiles,recording"
